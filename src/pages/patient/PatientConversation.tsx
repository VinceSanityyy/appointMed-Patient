...
export const PatientConversation: React.FC = () =>{
    ...
    useIonViewWillEnter(()=>{
        ...
        firebase.database().ref('messages/').orderByChild('reciever').equalTo(localStorage.getItem('uid')).on('value',(snapshot)=>{
            let key;
            let newArr = []
   ...
   const sendMessage = ()=>{
        ...
        firebase.database().ref('messages').push({
            sec:conversationDetails['sender'],
            pat:localStorage.getItem('uid'),
